...
function MiniMatchRow({ league, match, onOpenMatches }) {
  ...
  const content = (
    <>
      ...
      <span className="mini-match-team">
      ...
      <span className="mini-match-team away">
        <strong>{away?.name || "VISITANTE"}</strong>
...
function getSuspensionOriginLabel(league, notice) {
  const match = getSuspensionOriginMatch(league, notice);
  if (match) {
...
function getSuspensionOriginMatch(league, notice) {
